...
async def get_report(
    ...
    report = await service.get_report(db, research_id)
...
async def export_markdown(
    ...
    filename, content = await service.export_markdown(db, research_id)
    return Response(
        content=content,
...
async def export_pdf(
    ...
    filename, pdf_bytes = await service.export_pdf(db, research_id)
    return Response(
        content=pdf_bytes,
